...
<head runat="server">
    <title>IShopClothes Triệu người bán - Tỷ người mua</title>
...
<body>
            ...
            <div id="timkiem">
                ...
                <div class="timkiemphai">
                    ...
                    <div class="hotline">
                        ...
                        <div class="number">0983.172.229 - 0973.536.910</div>
                    </div>
                    <div class="otimkiem">
                        <div class="search">
                            <div id="searchForm">
            ...
            <div id="trangtrai">
                   ...
                   <div id="pichotro">
                    ...
                    <div class="support">
                        <div class="text-center">
                            <p>
                                <span class="supp-name">Thuận Lê</span>
                                <br />                    
                                <span class="phone">0983.172.229</span>
                            </p>                    
                        </div>
                        <div class="text-center">
                            <p>
                                <span class="supp-name">Lê Hoàng</span>
                                <br />
                                <span class="phone">0973.536.910</span>
                            </p>                            
                        </div>
                        <div class="text-center">
                            <p>
                ...
                <div id="thanhtoan">
                    ...
                    <div class="thongtinnganhang">
                        <div class="nganhang">
                            <img src="../css/images/nganhang/msb.png" />
                            <p>
                                <strong>Ngân hàng MSB</strong>
                                <br>
                                Số TK: 0440 1015 9752 84
                                <br>
                                Chủ TK: Lê Văn Thuận
                                <br>
                                Chi nhánh Phổ Quang - Hồ Chí Minh
                            </p>
                        </div>
                    </div>                   
                </div>
    ...
    <div id="footer">
        <div class="contener">
            <div class=" menufoter">
                <p>©2024 Copyright by ThuanLe.vn</p>
            </div>
        </div>
    </div>
    </form>
